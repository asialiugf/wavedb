...
```sql
-- 列精度 SECOND，WHERE 用 DAY 字面量
SELECT * FROM t WHERE ts >= 20260511 AND ts <= 20260511;
-- >= 20260511 → 2026-05-11 00:00:00（DAY 字面量，保持不变）
-- <= 20260511 → 2026-05-11 23:59:59.999999（扩展到当天末尾）
```
